    ...
    stages{
      ...
      stage('Get Version'){         
          ...
          steps{
             ...
             script{
                    echo "Version antes do script ${PROJECT_VERSION}"
                    PROJECT_VERSION = readMavenPom().getVersion()      
                    echo "Version depois do script ${PROJECT_VERSION}"
                }                                    
            }         
        }  
      stage('Deploy'){
          ...
          post{
              success{   
                  emailext body: readFile("C:/Users/Atomic/Desktop/jenkinsFile_sample/Novo e-mail.template"),                       //Deploy do Framework realizado com sucesso. \nVersão do Projeto: 
                  subject: 'Deploy Nexus - $BUILD_STATUS ', 
                  to: 'henrique.galli@atomicsolutions.com.br'
                  
              }
              failure{
                  emailext body:  readFile("C:/Users/Atomic/Desktop/jenkinsFile_sample/Novo e-mail.template")  ,                                                           
                  subject: 'Deploy Nexus - $BUILD_STATUS', 
                  to: 'henrique.galli@atomicsolutions.com.br'
              }
          } 
